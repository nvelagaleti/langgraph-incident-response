#!/usr/bin/env python3
"""
OAuth Retry - Since it worked once, let's try again with better handling
"""
...
def generate_auth_url():
    ...
    print("🔐 OAuth Retry - Let's try again!")
    print("=" * 50)
    ...
    print(f"5. You'll be redirected to: {redirect_uri}?code=AUTHORIZATION_CODE")
    print(f"6. Copy ONLY the code part (after 'code=')")
...
def exchange_code_for_token(auth_code):
    ...
    # Clean the auth code (remove any extra characters)
...
async def test_mcp_integration(access_token):
...
def main():
    ...
    print(f"💡 Make sure to copy ONLY the code part, not the full URL")
    ...
    mcp_success = asyncio.run(test_mcp_integration(access_token))
